                ...
                if (state is ProfileLoading || state is ProfileInitial) {
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        const ProfileHeader(textPrimary: ProfilePage._textPrimary),
                        const SizedBox(height: 18),
                        ProfileInfo(
                          profile: profile,
                          primaryColor: ProfilePage._primary,
                          textPrimary: ProfilePage._textPrimary,
                          textMuted: ProfilePage._textMuted,
                        ),
...
class _LibraryTabItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color foreground = isActive
        ? ProfilePage._primary
        : ProfilePage._textMuted;
          ...
          children: [
            ...
            Positioned(
              ...
              child: Text(
                'PLANT',
                style: TextStyle(
                  color: ProfilePage._primary.withValues(alpha: 0.75),
                  fontSize: 11,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: ProfilePage._secondary.withValues(alpha: 0.32),
        ),
      ),
      child: Material(
